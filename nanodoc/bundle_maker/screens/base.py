...
class Screen(ABC):
    ...
    def render_status_line(self, status_text: str) -> None:
        ...
        """
        try:
            self.stdscr.addstr(self.height - 1, 0, " " * self.width, curses.color_pair(5))
    ...
    def show_help(self) -> None:
        ...
        self.stdscr.clear()
        self.safe_addstr(0, 0, self._get_string("screen_title_help"), curses.A_BOLD | curses.color_pair(1))
        ...
        self.safe_addstr(2 + len(lines) + 2, 0, self._get_string("common.continue_prompt"))
        self.stdscr.refresh()
        self.stdscr.getch()
