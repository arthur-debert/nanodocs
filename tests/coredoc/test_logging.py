...
from nanodoc.makerapp.logging import (
    configure_logging,
    get_log_file,
    get_logger,
    set_log_level,
...
class TestLogging(unittest.TestCase):
    ...
    def setUp(self):
        """Set up the test."""
        # Use the LOG_DIR from the logging module
        self.log_dir = LOG_DIR
        os.makedirs(self.log_dir, exist_ok=True)

        # Create a test log file
        self.log_file = os.path.join(
            tempfile.gettempdir(), "test_nanodoc_bundle_maker.log"
        )
    ...
    def tearDown(self):
        ...
        if (
            ...
            and "test_nanodoc_bundle_maker.log" in self.log_file
        ):
